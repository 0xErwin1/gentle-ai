...
func TestPortableSDDFailClosedAuthorityJourneysAreRegistered(t *testing.T) {
	...
	// proves #2716's inventory-selected untracked candidate accounting. j87
	...
	// 98 -> 99: this branch's j84 joins the current main corpus. Taking either
	// pre-merge baseline would leave the guard describing a tree that does not exist.
