...
- Review launch runs from an ordinary already-running OpenCode session: no restart, child process, special user-visible session, or `OPENCODE_DISABLE_*` variable is required (rdd-advisory-transport SKILL.md).
