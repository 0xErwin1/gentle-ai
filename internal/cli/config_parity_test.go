...
var selectionParity = map[string]parityDisposition{
	...
	"SkillExclusions":      represented("SkillExclusions"),
	...
	"SkillAssignments":     represented("Providers"),
	"MCPServerAssignments": represented("Providers"),
	...
	"PiModelAssignments":          represented("Providers"),
