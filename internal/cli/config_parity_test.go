...
var selectionParity = map[string]parityDisposition{
	...
	"ClaudePhaseAssignments":      gap("ClaudePhaseAssignments"),
	"KiroModelAssignments":        gap("KiroModelAssignments"),
	"CodexModelAssignments":       gap("CodexModelAssignments"),
	"CodexOrchestratorAssignment": gap("CodexOrchestratorAssignment"),
